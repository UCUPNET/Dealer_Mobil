        ...
        <div class="flex pt-32 justify-between gap-8 items-start px-20 ">
            ...
            <div class="w-[70%] mb-28 shadow-lg p-10">
                ...
                <div class="flex justify-between py-5 border-b-2">
                    ...
                    <p class="text-[#E71D4F] font-extrabold">Rp134.000.000</p>
                </div>
                ...
                <div class="flex flex-col gap-8 ">
                    ...
                    <div class="flex justify-between gap-9 mb-10 text-xs">
                        <div>
                            <p>Mobil Daihatsu Rocky adalah sebuah Sport Utility Vehicle (SUV) kompak yang diproduksi
                                oleh perusahaan otomotif Jepang, Daihatsu. Diluncurkan pada tahun 2019, Rocky menawarkan
                                desain yang kuat dan unik dengan kemampuan off-road yang tangguh.:</p>
                        </div>
                        <div>
                            <p>Rocky tersedia dengan pilihan mesin bensin 1.2 liter 3-silinder yang bertenaga, yang mampu menghasilkan sekitar 87 tenaga kuda. Mesin ini dikombinasikan dengan transmisi manual 5 percepatan atau transmisi otomatis CVT untuk memberikan performa yang halus dan efisien.:</p>
                        </div>
                    </div>
